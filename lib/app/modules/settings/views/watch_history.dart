...
class WatchHistory extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Obx(() {
        if (homeController.isWatchhistoryLoading.value) {
        ...
        if (homeController.watchjistoryitems.isEmpty) {
          return Center(
            child: Text(
              'No items in your watch history',
              style: TextStyle(color: Colors.white, fontSize: 16.sp),
            ),
          );
        }
            ...
            child: Column(
              ...
              children: [
                ...
                GridView.builder(
                  ...
                  itemCount: homeController.watchjistoryitems.length,
                  shrinkWrap: true,
                  physics: const NeverScrollableScrollPhysics(),
                  itemBuilder: (context, index) {
                    final item = homeController.watchjistoryitems[index];
                    String imageUrl = '';
                    String title = '';
                    String aliasType = '';
                            ...
                            children: [
                              ...
                              Positioned(
                                ...
                                child: GestureDetector(
                                  onTap: () async {
                                    await homeController.removeFromWatchhistory(item.id, aliasType);
                                  },
                                  child: Container(
